...
def render_stock_visualizations(results):
    ...
    try:
        ...
        st.warning("""
        **Important Notice:**  
        This project is a non-commercial academic endeavor, and its purpose is solely for educational use.  
        The predictions generated by this model are based on historical data and statistical analysis.  
        While these predictions may provide insights, they are not intended for use in actual trading decisions.  
        Users should be aware that using these predictions, especially for commercial purposes, could involve financial risk.  
        Please exercise caution and consult with a qualified financial advisor before making any investment or trading decisions.""")
